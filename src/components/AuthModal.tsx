  ...
  return (
    <>
          ...
          onSubmit={async (e) => {
            ...
            if (mode === 'signup') {
              try {
                ...
                await createUser({ name, email, publicKey: publicKeyJwk }, { skipGlobalError: true });
              ...
              try {
                const keyPair = await dpopManager.generateAndSetKeyPair();
                const publicKeyJwk = await exportPublicKey(keyPair.publicKey);
                const response = await loginUser({ email, password, publicKey: publicKeyJwk }, { skipGlobalError: true });
          ...
          >
            <div className="flex items-center gap-3">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1c-2.47 0-4.57 1.63-5.26 3.86l2.85 2.22c.66-1.95 2.5-3.41 4.69-3.41z" fill="#EA4335" />
              </svg>
      ...
      <ErrorModal
        ...
        onAction={() => {
          setErrorModal((prev: any) => ({ ...prev, isOpen: false }))
